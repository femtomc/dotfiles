...
return packer.startup(function(use)
	...
	use({
		...
		config = function()
			require("lean").setup({
				...
				lsp = { on_attach = require("user.lsp.handlers").on_attach },
				lsp3 = { on_attach = require("user.lsp.handlers").on_attach },
				mappings = true,
			})
		end,
	})
	...
	-- Quarto LSP
	use({ "quarto-dev/quarto-nvim", requires = { "neovim/nvim-lspconfig", "jmbuhr/otter.nvim" } })
